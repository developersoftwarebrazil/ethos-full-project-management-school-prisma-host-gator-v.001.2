        ...
        <div className={styles.heroGrid}>
          <div className={styles.textContainer}>
            <p className={styles.subtitle}>
              ...
              que ministra cursos a distância em Psicanálise e afins (EAD),
            ...
            <p className={styles.subtitle}>
              ...
              Psicanálise e Análises Clínicas. São 12 (meses) módulos
              envolvendo: Teoria, Discussão de Caso, Tripé Analítico (teoria,
