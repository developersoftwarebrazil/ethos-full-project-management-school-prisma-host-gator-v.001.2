...
import { createEvent, updateEvent } from "@/lib/actions/index";
...
const EventForm = ({
  ...
  useEffect(() => {
    if (state.success) {
      toast(`O evento foi ${type === "create" ? "criado" : "atualizado"}!`);
      setOpen(false);
      router.refresh();
    }
  ...
  return (
    <form className="flex flex-col gap-8" onSubmit={onSubmit}>
      <h1 className="text-xl font-semibold">
        {type === "create" ? "Criar um novo evento" : "Atualizar evento"}
      </h1>
